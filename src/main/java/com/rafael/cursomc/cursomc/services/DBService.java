...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Categoria cat7 = new Categoria(null, "Roupas Masculinas");
        Categoria cat8 = new Categoria(null, "Roupas Femininas");
        Categoria cat9 = new Categoria(null, "Decoração");
        ...
        p2.getCategorias().addAll(Arrays.asList(cat, cat2, cat4));
        ...
        categoriaRepository.saveAll(Arrays.asList(cat,cat2,cat3,cat4,cat5,
                cat6,cat7,cat8,cat9));
        ...
        Cliente cli2 = new Cliente(null, "Rafael Mendes", "rafael@gmail.com", "26416658402", TipoCliente.PESSOA_FISICA, passwordEncoder.encode("123") );
        cli2.addPerfil(Perfil.ADMIN);
        cli1.getTelefones().addAll(Arrays.asList("123456789"));

        Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
        Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);

        Endereco e3 = new Endereco(null, "Rua Paulo Gusmão", "178", null, "Oeste Cabral", "14785942", cli2, c3);
        ...
        Pedido ped3 = new Pedido(null, sdf.parse("15/03/2018 10:47"), cli2, e3);
        ...
        Pagamento pagto3 = new PagamentoComBoleto(null, EstadoPagamento.QUITADO, ped3, sdf.parse("16/03/2018 00:00"), null);
        ...
        ItemPedido ip4 = new ItemPedido(ped3, p2, 0.00, 5, 800.00);
